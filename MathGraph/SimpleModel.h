...
public:
    ...
    void initParticles(float particleLifetime) {
        GLuint initVel, startTime, particles, nParticles = 8000;
        Random rand;
        ...
        std::vector<GLfloat> data1(nParticles);
        float rate = particleLifetime / nParticles;
        for (int i = 0; i < nParticles; i++) {
            data1[i] = rate * i;
        }
        glBindBuffer(GL_ARRAY_BUFFER, startTime);
        glBufferSubData(GL_ARRAY_BUFFER, 0, nParticles * sizeof(float), data1.data());
